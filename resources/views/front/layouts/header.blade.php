                ...
                <div class="mobile-header__body">
                    ...
                    <button class="mobile-header__menu-button">
                        <svg width="18px" height="14px">
                            <use xlink:href="{{ asset('images/front/sprite.svg#menu-18x14') }}"></use>
                        </svg>
                    </button>

                    <a class="mobile-header__logo" href="{{ route('front.home') }}">
...
{{--                                <span class="indicator__area">--}}
{{--                                    <svg width="20px" height="20px">--}}
{{--                                        <use xlink:href="{{ asset('images/front/sprite.svg#heart-20') }}"></use>--}}
{{--                                    </svg>--}}
    ...
    <div class="site-header">
                            ...
                            @else
                                <button class="topbar-dropdown__btn" type="button">
                                    ...
                                    <svg width="7px" height="5px">
                                        <use xlink:href="{{ asset('images/front/sprite.svg#arrow-rounded-down-7x5') }}"></use>
                                    </svg>
                                </button>
                    ...
                    <div class="topbar__item">
                        <div class="topbar-dropdown">
                            <button class="topbar-dropdown__btn" type="button">{{ __('Language') }}:
                                <span class="topbar__item-value">{{ __('languages.'.app()->getLocale()) }}</span>
                                <svg width="7px" height="5px">
                                    <use
                                        xlink:href="{{ asset('images/front/sprite.svg#arrow-rounded-down-7x5') }}"></use>
                                </svg>
                            </button>
                            <div class="topbar-dropdown__body">
                                <ul class="menu menu--layout--topbar menu--with-icons">
                                    @foreach(config('app.locales') as $lng)
                                        <li>
                                            <a href="{{ route('front.locale.set', ['locale' => $lng]) }}">{{ __('languages.'.$lng) }}</a>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
        ...
        <div class="site-header__middle container">
            ...
            <div class="site-header__search">
                <div class="search">
                    <form class="search__form" action="#">
                        <input class="search__input" name="search" placeholder="{{ __('Search') }}"
                               aria-label="{{ __('Site search') }}" type="text" autocomplete="off">
            ...
            <div class="site-header__phone">
                <div class="site-header__phone-title">{{ __('Phone') }}</div>
                ...
                <div class="nav-panel__container container">
                    <div class="nav-panel__row">
                        ...
                        <div class="nav-panel__departments">
                            ...
                            <div class="departments @if(Route::currentRouteName() == 'front.home') departments--opened departments--fixed @endif"
                                 @if(Route::currentRouteName() == 'front.home') data-departments-fixed-by=".block-slideshow" @else data-departments-fixed-by=""@endif>
                                    ...
                                    <div class="departments__links-wrapper">
                                        <ul class="departments__links">
                                            ...
                                            @foreach($categories as $cat)
                                                ...
                                                @else
                                                    <a class="departments__item" href="{{ route('front.category', ['slug' => $cat->slug]) }}">{{ $cat->translate->name }}</a>
                                                @endif
                                            @endforeach
                                ...
                                <button class="departments__button">
                                    <svg class="departments__button-icon" width="18px" height="14px">
                                        <use
                                            xlink:href="{{ asset('images/front/sprite.svg#menu-18x14') }}"></use>
                                    </svg>
                                    {{ __('Сategories') }}
                                    <svg class="departments__button-arrow" width="9px" height="6px">
                                        <use
                                            xlink:href="{{ asset('images/front/sprite.svg#arrow-rounded-down-9x6') }}"></use>
                                    </svg>
                                </button>
                            </div>
                        ...
                        <div class="nav-panel__nav-links nav-links">
                            <ul class="nav-links__list">
                                ...
                                <li class="nav-links__item @if(Route::currentRouteName() == 'front.home') active @endif">
                                    <a href="{{ route('front.home') }}">
                                        <span>{{ __('Home') }}</span>
                                    </a>
                                </li>
                                <li class="nav-links__item @if(Route::currentRouteName() == 'front.blog') active @endif">
                                    <a href="{{ route('front.blog') }}">
                                        <span>{{ __('Blog') }}</span>
                                    </a>
                                </li>
                                <li class="nav-links__item @if(Route::currentRouteName() == 'front.about') active @endif">
                                    <a href="{{ route('front.about') }}">
                                        <span>{{ __('About us') }}</span>
                                    </a>
                                </li>
                                <li class="nav-links__item @if(Route::currentRouteName() == 'front.contacts') active @endif">
